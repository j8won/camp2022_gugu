    ...
    <Container>
      ...
      <SettingBtn
        onClick={() => {
          ...
          setSettingType(SETTING_TYPES.USER);
        }}
      >
        <IoMdSettings />
      </SettingBtn>
